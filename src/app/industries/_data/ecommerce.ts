...
const data: IndustryPageData = {
  ...
  stories: [
    { brand: "A DTC skincare brand doing $50K/month", challenge: "Spending $3,000/month on 10 UGC videos. Only 2–3 performed well enough to scale. Couldn't test fast enough to find winners.", did: "Switched to ReUGC Pro plan ($99/month). Generated 25 testimonial videos with different hooks, actors, and angles. Tested 5 hooks per winning script.", result: "Found 4 winning creatives in the first month. CPA dropped 42%. Content spend went from $3,000 to $99/month." },
    { brand: "A Shopify accessories brand scaling to $200K/month", challenge: "Needed 40+ fresh creatives per month to feed Meta and TikTok campaigns. Agency quoted $20,000/month for that volume.", did: "Used ReUGC Pro Plus ($199/month for 60 videos). Created a script library for each product and generated variations weekly.", result: "Producing 60 creatives per month at $199 instead of $20,000. Testing velocity increased 6x. Found 2 viral creatives that drove $80K in revenue." },
    { brand: "An Amazon FBA brand launching on TikTok Shop", challenge: "Had zero video content. Needed to launch TikTok Shop with UGC-style product videos but had no creator relationships.", did: "Created 15 product review and demo videos using ReUGC Starter plan ($49/month). Launched TikTok Shop with video content on day one.", result: "Generated $12K in TikTok Shop revenue in the first month. Video ads drove 3x more conversions than static image ads." },
  ],
  faq: [
