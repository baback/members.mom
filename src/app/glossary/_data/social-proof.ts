...
const data: GlossaryPageData = {
  ...
  relatedNote: "Social proof is the psychological mechanism that makes UGC and UGC ads effective. It's leveraged through influencer marketing (celebrity/expert proof), embedded in landing pages (reviews and testimonials), and is a core element of direct response marketing. Higher social proof directly improves conversion rates.",
};
export default data;
