...
const data: GlossaryPageData = {
  ...
  product: {
    intro: "members.mom creates content that's designed for repurposing from the start:",
    points: [
      "Modular video structure — Videos generated by members.mom have clear hook, body, and CTA sections that can be easily separated for platform-specific cuts. One generation, multiple usable assets.",
