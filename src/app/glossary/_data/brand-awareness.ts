...
const data: GlossaryPageData = {
  ...
  relatedNote: "Brand awareness is the first stage of the marketing funnel, followed by consideration and conversion campaigns. It's built through paid social and organic social, measured partly through CPM efficiency, and most effectively delivered through short-form video content.",
};
export default data;
