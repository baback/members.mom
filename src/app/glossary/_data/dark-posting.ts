...
const data: GlossaryPageData = {
  ...
  relatedNote: "Dark posting is the distribution method that enables aggressive split testing and creative testing without affecting your organic presence. It contrasts with whitelisting and Spark Ads, which use visible organic posts as ad creative. Dark posts are the standard delivery mechanism for ad creative on paid social platforms.",
};
export default data;
