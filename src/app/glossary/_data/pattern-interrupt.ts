...
const data: GlossaryPageData = {
  ...
  relatedNote: "Pattern interrupts are the primary technique for creating scroll-stopping content and effective hooks. Their impact is measured by thumb-stop rate and hook rate. They're optimized through creative testing and are a core component of high-performing ad creative.",
};
export default data;
