...
const data: GlossaryPageData = {
  ...
  product: {
    intro: "members.mom produces the native-looking video content that paid social platforms reward:",
    points: [
      "Platform-native content — Every video generated by members.mom is designed to look like organic social content, not a polished ad. This native feel earns better engagement scores, lower CPMs, and higher CTRs across Meta and TikTok.",
      ...
      "Creative volume for always-on campaigns — Paid social requires constant creative refreshes. members.mom's plans ($49–$199/mo) ensure you always have fresh content ready to deploy across every platform.",
    ],
  },
  related: [
