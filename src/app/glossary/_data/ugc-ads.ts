...
const data: GlossaryPageData = {
  ...
  relatedNote: "UGC ads are the execution layer where UGC content meets paid distribution. Their performance depends on strong hooks (hook rate), compelling ad creative, and consistent refreshes to avoid creative fatigue — all within the paid social ecosystem.",
};
export default data;
