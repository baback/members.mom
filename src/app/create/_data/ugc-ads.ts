...
const data: CreatePageData = {
  ...
  framework: [
    ...
    { step: "The Payoff", time: "8–20 seconds", what: "Show the result or transformation. For UGC ads, this is where you demonstrate the product or share the outcome.", examples: ["\"I switched to members.mom three months ago. I'm producing 30 videos a month now and my CPA dropped 40%. My creative team actually has time to strategize instead of chasing creators.\""], why: "The payoff needs numbers or visible proof. '30 videos a month' and 'CPA dropped 40%' are specific enough to be believable without sounding like marketing copy." },
