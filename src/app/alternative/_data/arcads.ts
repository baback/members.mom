...
const data: AlternativePageData = {
  ...
  verdict: "If you're leaving Arcads because of pricing, ReUGC gives you more videos at a fraction of the cost ($49/month for 10 videos vs Arcads' $250 for 50). For pure UGC-style output, ReUGC and MakeUGC are the strongest options.",
  criteria: SHARED_CRITERIA,
  pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Arcads", "$250", "50", "$5.00", "~30", "12", true, false, "Basic"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Synthesia", "$99", "Limited", "~$10+", "140+", "60+", false, false, "Strong"]] },
  ...
  faq: [
    ...
    { q: "What's the cheapest Arcads alternative?", a: "Per-video, MakeUGC ($3.27) and Creatify ($3.90) are cheapest. ReUGC at $4.90/video offers the best balance of price, quality, and features." },
