...
const data: AlternativePageData = {
  ...
  verdict: "Runway is the best AI video generation tool for creative/cinematic work. For UGC ad creative with talking heads and scripts, members.mom is purpose-built and far simpler to use.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Runway", "$15+", "Limited credits", "Varies", "Generated (no actors)", "N/A", false, false, "N/A"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How does Runway compare to members.mom?", a: "Runway generates cinematic video from text prompts. members.mom generates UGC-style talking-head videos from scripts. Completely different tools." },
    { q: "What's the best Runway alternative for ads?", a: "members.mom for UGC ads. Runway is better suited for creative/cinematic content, not performance marketing." },
  ],
