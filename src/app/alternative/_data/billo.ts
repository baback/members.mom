...
const data: AlternativePageData = {
  ...
  verdict: "Billo delivers authentic human UGC but at 50x the cost and 100x the turnaround time. ReUGC generates UGC-style video from scripts in minutes at $4.90/video. For creative testing at volume, AI wins on speed and cost.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [MAKEUGC, CREATIFY, HEYGEN, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Billo", "$100+/video", "Varies", "$100–$300", "Real humans", "1 (English)", true, false, "N/A (real)"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"]] },
