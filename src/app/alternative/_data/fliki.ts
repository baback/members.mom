...
const data: AlternativePageData = {
  ...
  verdict: "Fliki is a solid text-to-video tool for content repurposing. For UGC-style ad creative with realistic AI actors, members.mom is purpose-built for that use case.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Fliki", "$28+", "Varies", "Varies", "Stock + basic", "75+", false, false, "Basic"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "What's the best Fliki alternative for UGC?", a: "members.mom for UGC-style ads with realistic AI actors. Fliki and members.mom solve different problems." },
