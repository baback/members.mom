...
const data: AlternativePageData = {
  ...
  verdict: "members.mom offers better UGC output quality, 29 languages (vs Creatify's 8), and batch generation. If you specifically need URL-to-video, Creatify is still the only tool that does it well.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, ARCADS, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Arcads", "$250", "50", "$5.00", "~30", "12", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How many languages does Creatify support?", a: "8 languages. If you need multilingual content, members.mom supports 29 languages with native lip sync." },
    ...
    { q: "What's better than Creatify for UGC ads?", a: "members.mom produces more authentic UGC output with better lip sync, more languages, and batch generation. The trade-off is no URL-to-video feature." },
  ],
