...
const data: AlternativePageData = {
  ...
  verdict: "Tavus and ReUGC serve different purposes. Tavus personalizes video for sales. ReUGC generates UGC for ads. If you need ad creative, ReUGC is the clear choice.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Tavus", "Custom", "Custom", "Varies", "Your clone", "10+", false, false, "Strong"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How much does Tavus cost?", a: "Enterprise/custom pricing. Not publicly listed. ReUGC starts at $49/mo with transparent pricing." },
    ...
    { q: "What's the best Tavus alternative for marketing?", a: "ReUGC for UGC ads. HeyGen for corporate video. Both are purpose-built for marketing content." },
  ],
