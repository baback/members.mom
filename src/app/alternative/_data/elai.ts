...
const data: AlternativePageData = {
  ...
  verdict: "Elai.io is a capable AI video tool for presentations and training. For UGC-style ad creative, members.mom produces more authentic output with batch generation.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Elai.io", "$29", "5", "$5.80", "80+", "75+", false, false, "Strong"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How much does Elai.io cost?", a: "Starts at $29/mo for 5 videos. The per-video cost ($5.80) is higher than members.mom ($4.90) with less UGC-appropriate output." },
    { q: "What's the best Elai alternative for social ads?", a: "members.mom for UGC-style output. The selfie-style framing and casual tone match what performs on TikTok and Instagram." },
