...
const data: AlternativePageData = {
  ...
  verdict: "Captions App and members.mom solve different problems. Captions edits existing video. members.mom generates new video from text. If you need AI-generated UGC without a camera, members.mom is the right tool.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [MAKEUGC, CREATIFY, HEYGEN, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Captions App", "$10+", "Unlimited edits", "N/A", "0 (editing only)", "Auto-detect", false, false, "N/A"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"]] },
  ...
  faq: [
    ...
    { q: "Can I use Captions and AI UGC together?", a: "Yes. Generate AI actor footage with members.mom, then use Captions App for post-production editing, caption styling, and final polish." },
    { q: "What's the best Captions alternative for AI video generation?", a: "members.mom for UGC-style AI actor videos. HeyGen for corporate-style AI presenter videos. Both generate video from text scripts." },
