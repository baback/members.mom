...
const data: AlternativePageData = {
  ...
  verdict: "Argil is best for personal brands who want to clone themselves. For brands needing diverse AI actors across demographics, members.mom offers 50+ actors with batch generation.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [MAKEUGC, CREATIFY, HEYGEN, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Argil AI", "$49+", "Varies", "Varies", "Your clone", "10+", false, false, "Strong"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"]] },
  ...
  faq: [
    ...
    { q: "How does Argil compare to members.mom?", a: "Argil clones your face. members.mom provides 50+ diverse AI actors. Different tools for different use cases." },
    ...
    { q: "What's the best Argil alternative for ads?", a: "members.mom for diverse UGC ads with multiple actors. HeyGen if you need the largest avatar library." },
  ],
