...
const data: AlternativePageData = {
  ...
  verdict: "UGC agencies provide a done-for-you service that's hard to beat for convenience. But at $3,000–$15,000/month, you're paying a massive premium. ReUGC delivers comparable UGC output at $49–$199/month — freeing up thousands for ad spend.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [MAKEUGC, CREATIFY, HEYGEN, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["UGC Agency", "$3K–$15K/mo", "10–30", "$150–$500", "Real humans", "1–3", true, false, "N/A"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"]] },
  ...
  faq: [
    ...
    { q: "How much do UGC agencies charge?", a: "Typically $3,000–$15,000/month for 10–30 videos. Some charge per-video rates of $150–$500. ReUGC starts at $49/month for 10 videos." },
    ...
    { q: "What's the ROI of switching from agency to AI?", a: "If you're spending $5,000/month on an agency and switch to ReUGC at $199/month, you save $4,800/month — $57,600/year. That's ad budget you can reinvest." },
  ],
