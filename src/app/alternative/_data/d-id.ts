...
const data: AlternativePageData = {
  ...
  verdict: "D-ID is best for developers who need API-first avatar generation. For marketing teams creating UGC ads, members.mom delivers more authentic output with simpler pricing.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["D-ID", "$5.90+", "Credit-based", "Varies", "Photo-based", "30+", false, false, "Basic"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How does D-ID pricing work?", a: "D-ID uses a credit-based system that varies by usage. It's harder to predict monthly costs compared to flat-rate plans like members.mom's $49/mo." },
    ...
    { q: "What's the best D-ID alternative for marketing?", a: "members.mom for UGC ads, HeyGen for corporate video. Both offer simpler pricing and better output for marketing use cases." },
  ],
