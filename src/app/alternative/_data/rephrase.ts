...
const data: AlternativePageData = {
  ...
  verdict: "Rephrase.ai solves a different problem (personalized video). For scalable UGC ad creative, ReUGC is purpose-built with batch generation and native UGC output.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, DID],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Rephrase.ai", "Custom", "Custom", "Varies", "25+", "10+", false, false, "Strong"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How does Rephrase.ai pricing work?", a: "Custom/enterprise pricing. Not transparent. ReUGC starts at $49/mo with clear per-video costs." },
    { q: "What's the best alternative for UGC ads?", a: "ReUGC for batch UGC generation. Creatify if you need URL-to-video for e-commerce." },
    { q: "Can Rephrase.ai do batch generation?", a: "Rephrase.ai can personalize at scale (different names/details per video) but not batch-test different hooks and scripts like ReUGC." },
  ],
