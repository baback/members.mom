...
const data: AlternativePageData = {
  ...
  verdict: "Vidyo.ai is great for repurposing existing long-form content. members.mom creates original UGC content from scripts. Use both if you have long-form content to repurpose AND need original UGC ads.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Vidyo.ai", "$30+", "Clips (not videos)", "N/A", "0 (repurposing)", "Auto-detect", false, false, "N/A"], ["members.mom", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "Can I use Vidyo and AI UGC together?", a: "Yes. Use Vidyo.ai to repurpose podcasts and webinars. Use members.mom to create original UGC ad content from scripts." },
    { q: "What's the best Vidyo alternative for UGC?", a: "members.mom for original UGC creation. Vidyo.ai and members.mom are complementary, not competing tools." },
