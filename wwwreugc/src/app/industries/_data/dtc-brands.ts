...
const data: IndustryPageData = {
  ...
  stories: [
    { brand: "A DTC supplement brand at $30K/month", challenge: "Stuck at $30K/month for 6 months. Running the same 5 ad creatives. CPA was climbing and ROAS was declining.", did: "Switched to ReUGC Pro plan. Created 25 videos in the first week — 5 scripts × 5 hook variations. Launched systematic creative testing.", result: "Found 3 winning creatives in week 2. Scaled from $30K to $75K/month in 60 days. CPA dropped 38%." },
