...
const data: AlternativePageData = {
  ...
  verdict: "Insense is great for brands that want real creator relationships and whitelisting. But for pure UGC ad creative at volume, ReUGC delivers 10x more content at a fraction of the cost and turnaround.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [MAKEUGC, CREATIFY, HEYGEN, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Insense", "$500+/campaign", "Varies", "$150–$400", "Real creators", "Varies", true, false, "N/A"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"]] },
  ...
  faq: [
    ...
    { q: "What's the minimum budget for Insense?", a: "Campaign minimums start around $500. ReUGC starts at $49/month for 10 videos." },
  ],
