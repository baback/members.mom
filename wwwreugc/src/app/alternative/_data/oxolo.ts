...
const data: AlternativePageData = {
  ...
  verdict: "Oxolo's URL-to-video is convenient but limited. ReUGC offers better UGC output quality, 29 languages, and batch generation for creative testing at scale.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [CREATIFY, HEYGEN, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Oxolo", "$25+", "Varies", "Varies", "~20", "10+", false, false, "Basic"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How does Oxolo compare to Creatify?", a: "Both offer URL-to-video features. Creatify has better e-commerce integration and more reliable output. Neither matches ReUGC for UGC quality." },
    { q: "What's the best Oxolo alternative?", a: "ReUGC for UGC ads. Creatify if you specifically need URL-to-video for e-commerce." },
    { q: "Does Oxolo support batch generation?", a: "No. Videos are created individually. ReUGC offers batch generation for creative testing." },
  ],
