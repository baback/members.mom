...
const data: AlternativePageData = {
  ...
  verdict: "For UGC-style marketing videos, ReUGC delivers the most authentic output at the best price. For corporate video with maximum language support, Synthesia is still the leader — but that's a different use case entirely.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, ARCADS, CREATIFY, MAKEUGC],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Synthesia", "$99", "Limited", "~$10+", "140+", "60+", false, false, "Strong"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "What's cheaper than Synthesia?", a: "ReUGC starts at $49/mo vs Synthesia's $99/mo business plan. For ad creative specifically, you get better UGC output at half the price." },
