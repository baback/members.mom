...
const data: AlternativePageData = {
  ...
  verdict: "VideoAI is still building its feature set. ReUGC offers more polished UGC output, 50+ actors, 29 languages, and batch generation — all at a competitive price point.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [MAKEUGC, CREATIFY, HEYGEN, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["VideoAI", "$39+", "Varies", "Varies", "Limited", "5+", true, false, "Basic"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"]] },
  ...
  faq: [
    ...
    { q: "How does VideoAI compare to ReUGC?", a: "ReUGC has more actors, better UGC output quality, 29 languages, and batch generation. VideoAI is still developing these capabilities." },
    { q: "What's the best VideoAI alternative?", a: "ReUGC for UGC ads. MakeUGC for English-only UGC. HeyGen for corporate video." },
    { q: "Does VideoAI support multilingual content?", a: "Limited language support. ReUGC supports 29 languages with native lip sync." },
  ],
