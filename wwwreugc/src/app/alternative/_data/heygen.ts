...
const data: AlternativePageData = {
  ...
  verdict: "If you need UGC-style output that looks native to TikTok, ReUGC is the clear winner. If you need the cheapest per-video cost and only need English, MakeUGC is solid. HeyGen remains best for corporate/educational content.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [ARCADS, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["Arcads", "$250", "50", "$5.00", "~30", "12", true, false, "Basic"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"], ["Synthesia", "$99", "Limited", "~$10+", "140+", "60+", false, false, "Strong"]] },
  methodology: SHARED_METHODOLOGY,
  faq: [
    { q: "Is HeyGen good for UGC ads?", a: "HeyGen excels at corporate and educational video. For UGC-style ads that look native to TikTok and Instagram, the output is too polished. Tools like ReUGC produce more authentic-looking content." },
    ...
    { q: "What's the best HeyGen alternative for TikTok ads?", a: "ReUGC produces the most native-looking UGC output for TikTok. MakeUGC is also strong but limited to English only." },
  ],
