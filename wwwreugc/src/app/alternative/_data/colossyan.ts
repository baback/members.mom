...
const data: AlternativePageData = {
  ...
  verdict: "Colossyan is a strong corporate video tool. For UGC-style marketing content, ReUGC delivers more authentic output at a better price point.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, SYNTHESIA, CREATIFY, MAKEUGC],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Colossyan", "$28", "5", "$5.60", "50+", "70+", false, false, "Strong"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Synthesia", "$99", "Limited", "~$10+", "140+", "60+", false, false, "Strong"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "What's the best Colossyan alternative for ads?", a: "ReUGC for UGC-style ads. The output looks native to TikTok and Instagram, which is what drives conversions on paid social." },
    { q: "Does Colossyan support batch generation?", a: "No. Like most corporate video tools, Colossyan creates videos one at a time. ReUGC offers batch generation for creative testing." },
  ],
