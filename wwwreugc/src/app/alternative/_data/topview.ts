...
const data: AlternativePageData = {
  ...
  verdict: "ReUGC produces more authentic UGC output than TopView with better lip sync and batch generation. If you want URL-to-video specifically, Creatify does it better than TopView.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [CREATIFY, HEYGEN, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["TopView", "$39", "10", "$3.90", "~15", "5", true, false, "Basic"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "What's the best TopView alternative for TikTok?", a: "ReUGC produces the most native-looking UGC for TikTok with batch generation for creative testing." },
    { q: "Does TopView support multiple languages?", a: "TopView supports about 5 languages. ReUGC supports 29 with native lip sync." },
  ],
