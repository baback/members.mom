...
const data: AlternativePageData = {
  ...
  verdict: "Hour One is solid for enterprise video. For UGC ads, ReUGC produces more authentic content at a fraction of the cost.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, SYNTHESIA, CREATIFY, MAKEUGC],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["Hour One", "$30", "3", "$10.00", "100+", "60+", false, false, "Strong"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Synthesia", "$99", "Limited", "~$10+", "140+", "60+", false, false, "Strong"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "How much does Hour One cost?", a: "Starts at $30/mo for 3 videos ($10/video). ReUGC is $4.90/video with UGC-appropriate output." },
    { q: "What's the best Hour One alternative for ads?", a: "ReUGC for UGC ads. The output looks native to TikTok and Instagram." },
