...
const data: AlternativePageData = {
  ...
  verdict: "InVideo and ReUGC solve different problems. InVideo is a video editor with templates. ReUGC generates AI actor UGC from scripts. If you need talking-head UGC ads, ReUGC is the clear choice.",
  criteria: SHARED_CRITERIA, pick: SHARED_PICK,
  alternatives: [HEYGEN, CREATIFY, MAKEUGC, SYNTHESIA],
  table: { headers: SHARED_TABLE_HEADERS, rows: [["InVideo", "$25", "Unlimited", "N/A", "0 (templates)", "70+", false, false, "N/A"], ["ReUGC", "$49", "10", "$4.90", "50+", "29", true, true, "Native"], ["HeyGen", "$29", "3", "$9.67", "150+", "40+", false, false, "Strong"], ["Creatify", "$39", "10", "$3.90", "~25", "8", true, false, "Basic"], ["MakeUGC", "$49", "15", "$3.27", "~20", "1", true, false, "Basic"]] },
  ...
  faq: [
    ...
    { q: "What's the best InVideo alternative for AI UGC?", a: "ReUGC generates realistic AI actor UGC from text scripts. It's a fundamentally different tool — generation vs editing." },
    { q: "Can I use InVideo and an AI UGC tool together?", a: "Yes. Generate the AI actor footage with ReUGC, then use InVideo for additional editing, text overlays, or combining with B-roll." },
  ],
