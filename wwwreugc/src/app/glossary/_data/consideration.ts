...
const data: GlossaryPageData = {
  ...
  relatedNote: "The consideration stage sits between brand awareness (top of funnel) and conversion campaigns (bottom of funnel). It leverages retargeting to reach interested prospects, uses social proof to build confidence, and often employs long-form video for the depth of information prospects need. Strong consideration content improves landing page conversion rates.",
};
export default data;
